            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 lg:gap-2 h-full">
              ...
              <div className="lg:col-span-3 h-auto lg:h-full">
                <Card className="h-full border-4 border-[#3298cb] rounded-lg overflow-hidden shadow-md bg-white">
                  <CardBody className="p-2 sm:p-4 lg:p-2 h-full overflow-y-auto">
                    ...
                    <Tabs value={activeTab} className="h-full">
                      ...
                      <TabsBody className="h-[calc(100%-40px)] overflow-y-auto">
                        {/* Stats Tab */}
                        <TabPanel value="stats" className="p-0 h-full flex flex-col">
                          {/* Main Stats Cards */}
                          ...
                          {/* Trainer Trivia */}
                          <Typography variant="h5" className="font-pixel text-sm text-[#2a6fa8] mt-4 sm:mt-6 mb-3">
                            Trainer Facts
                          </Typography>
                        ...
                        {/* Achievements Tab */}
                        <TabPanel value="achievements" className="p-0 h-full flex flex-col">
                          <Typography variant="h5" className="font-pixel text-sm text-[#2a6fa8] mb-3">
                            Achievements & Badges
                          </Typography>
                        ...
                        {/* Activity Tab */}
                        <TabPanel value="activity" className="p-0 h-full flex flex-col">
                          <Typography variant="h5" className="font-pixel text-sm text-[#2a6fa8] mb-3">
                            Recent Activity
                          </Typography>
